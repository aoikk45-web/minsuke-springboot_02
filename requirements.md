...
- 講師は外部委託か内部スタッフか（権限・個人情報アクセス範囲に影響）
...
| ID | 要件 | 区分 | MVP |
|---|---|---|---|
| FR-I01 | 講師情報の登録・編集 | Proposed | No |
| FR-I02 | 担当種目・資格管理 | Proposed | No |
| FR-I03 | 担当スケジュール・稼働状況 | Proposed | No |
...
| OQ-03 | スケジュールとイベントの関係 | Open | データモデル |
